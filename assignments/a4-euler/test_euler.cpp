...
void TestAllRoo(const Matrix3 &m)
{
    ...
    EXPECT_EQ(m, Matrix3(Matrix3::XYZ, test), test);
    std::cout << "XZY\n";
    test = m.toEulerAngles(Matrix3::XZY);
    EXPECT_EQ(m, Matrix3(Matrix3::XZY, test), test);
    
    std::cout << "YXZ\n";
    test = m.toEulerAngles(Matrix3::YXZ);
    EXPECT_EQ(m, Matrix3(Matrix3::YXZ, test), test);

    
    std::cout << "YZX\n";
    test = m.toEulerAngles(Matrix3::YZX);
    EXPECT_EQ(m, Matrix3(Matrix3::YZX, test), test);
    
    std::cout << "ZXY\n";
    test = m.toEulerAngles(Matrix3::ZXY);
    EXPECT_EQ(m, Matrix3(Matrix3::ZXY, test), test);
    std::cout << "ZYX\n";
    test = m.toEulerAngles(Matrix3::ZYX);
    EXPECT_EQ(m, Matrix3(Matrix3::ZYX, test), test);
    */
}
...
void TestEulerToMatrix_XZY()
{
    ...
    EXPECT_EQ(euler, Vector3(45, -30, 60) * Deg2Rad, euler);
...
void TestEulerToMatrix_YXZ()
{
    ...
    EXPECT_EQ(euler, Vector3(45, -30, 10) * Deg2Rad, euler);
